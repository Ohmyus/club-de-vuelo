...
\par Los agujeros se suelen deformar cuando se imprimen en la dirección perpendicular a las capas. Una recomendación sería incluir, cuando la precisión dimensional sea necesaria, modificaciones en el propio diseño del agujero, para que este no sea exactamente circular sino que el ángulo del saliente esté limitado. \todo{Incluir foto del rediseño del agujero.}

\subsection{Juntas en Cola de Milano}
Este tipo de juntas son geniales para conseguir montajes rápidos e inequívocos (si se utilizan correctamente). \todo{añadir foto de junta en cola de milano, explicar cómo hacerla asimétrica.}

\section{Piezas planas o placas}
A la hora de imprimir piezas planas o placas, es muy importante considerar si es realmente necesario imprimirlas. 