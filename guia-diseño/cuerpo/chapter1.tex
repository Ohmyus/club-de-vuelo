...
Fusion se puede descargar desde aquí: \url{https://www.autodesk.com/education/home}.
\par Es necesario iniciar sesión con la cuenta de \texttt{@alumnos.upm.es}, una vez hecho esto se puede solicitar acceso a Autodesk Fusion, y finalmente descargar el instalador.

\begin{figure}
    \centering
    \includegraphics[width=0.75\linewidth]{figures/fusion-download.png}
    \caption{Aquí se puede instalar fuison}
    \label{fusion-download}
\end{figure}

\par Esta parte está todavía en trabajo, me gustaría añadir una pequeña guía e imágenes del proceso. \todo{Instalación de Fusion}
