...
%\usepackage[lining]{ebgaramond}   %Una opción para la fuente
%\usepackage[lining]{CormorantGaramond}     %Otra opción para la fuente
%\usepackage{tgpagella}     %Otra opción para la fuente
