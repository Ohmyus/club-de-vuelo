...
\begin{figure}[ht]
	...
	\begin{tikzpicture}
		...
		\node[block, right=4cm of kinematics] (control) {Controlador\\USB};
...
\par A continuación, un cálculo de cinemática inversa resuelve a qué posiciones se deben mover cada uno de los motores para alcanzar esa posición. Una vez determinadas estas posiciones, estos datos son pasados al controlador USB mediante un ciclo de control de altra frecuencia, para mover los motores.
